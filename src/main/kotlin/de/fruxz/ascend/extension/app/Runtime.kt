...
import de.fruxz.ascend.application.configuration.MoltenCoreApp
 ...
 * @since 1.0
 */
fun runApp(appName: String, appVersion: Version = 1.0.version, appInstance: de.fruxz.ascend.application.configuration.MoltenCoreApp = de.fruxz.ascend.application.configuration.MoltenCoreApp(
	appName,
	appVersion
